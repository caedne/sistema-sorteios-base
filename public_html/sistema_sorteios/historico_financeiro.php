...
function getCorCategoria($cat) {
    $cat = strtolower($cat);
    if ($cat == 'carnes') return '#ef4444';
    if ($cat == 'bebidas') return '#f59e0b';
    return '#64748b';
}
?>
<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <form method="GET" class="filtros-financeiro">
                    ...
                    <div class="filtro-grupo">
                        ...
                        <select name="categoria" class="filtro-input">
                            ...
                            <option value="carnes" <?php echo $categoria_filtro == 'carnes' ? 'selected' : ''; ?>>🥩 Carnes</option>
                ...
                <div class="resumo-financeiro-grid">
                    <div class="resumo-card">
                        ...
                        <div class="resumo-valor" style="color: #22c55e;">R$ <?php echo number_format($total_geral_arrecadado, 2, ',', '.'); ?></div>
                    </div>
                            ...
                            <?php if (count($sorteios_vendidos) > 0): ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="tag-categoria" style="background: <?php echo getCorCategoria($venda['categoria']); ?>">
                                                <?php echo htmlspecialchars($venda['categoria']); ?>
                                            </span>
                                        </td>
                                        <td>
                                            <strong style="color: #1e293b;"><?php echo htmlspecialchars($venda['titulo']); ?></strong>
                                            <small style="color: #94a3b8; font-weight: bold;">#<?php echo str_pad($numVisual, 2, '0', STR_PAD_LEFT); ?></small>
                                        </td>
                                        <td>R$ <?php echo number_format($venda['valor_numero'], 2, ',', '.'); ?></td>
                                        <td>
                                            <strong style="background: #f1f5f9; padding: 4px 10px; border-radius: 6px;"><?php echo $venda['qtd_vendida']; ?></strong>
                                        </td>
                                        <td>
                                            <strong style="background: #fef3c7; color: #d97706; padding: 4px 10px; border-radius: 6px;">🏆 <?php echo $venda['qtd_premios']; ?></strong>
                                        </td>
